...
A = np.array([-4.31e1, -2.825e1, 2.714e1, -3.392e1, 1.925e1, -2.435e1, 3.806, 3.224e1])
B = np.array([7.072e-1, 6.159e-1, 9.274e-3, 4.739e-1, 5.213e-2, 5.125e-1, 1.566e-1, 1.924e-3])
C = np.array([-4.811e-4, -4.023e-4, -1.381e-5, -3.017e-4, 1.197e-5, -2.765e-4, -8.348e-5, 1.055e-5])
D = np.array([1.301e-7, 9.935e-8, 7.645e-9, 7.13e-8, -1.132e-8, 4.911e-8, 1.755e-8, -3.596e-9])

# Heat, Gibbs free energy, and Entropy of formation
HF298 = np.array([2.981e4, 1.475e5, 0, 8.298e4, -7.49e4, 5.003e4, 5.234e4, -2.42e5])
GF298 = np.array([1.307e5, 2.139e5, 0, 1.297e5, -5.087e4, 1.221e5, 6.816e4, -2.288e4])
